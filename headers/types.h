...
namespace golf {
	struct Data {
		...
		Data(std::string _surname = "Smith", std::string _name = "John", std::string _club = "International Golf Club", double _points = 42.0, int _birthYear = 1970) :surname(_surname), name(_name),club(_club), points(_points), birthYear(_birthYear) {};
